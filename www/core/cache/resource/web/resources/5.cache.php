<?php  return array (
  ...
  array (
    'id' => 5,
    'type' => 'document',
    'pagetitle' => 'Февральское поступление',
    'longtitle' => 'Февральское поступление товара и актуальные скидки',
    'description' => 'Экономьте на ремонте своего автомобиля, не упуская выгодных возможностей',
    'alias' => 'февральское-поступление',
    'link_attributes' => '',
    'published' => 1,
    'pub_date' => 0,
    'unpub_date' => 0,
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1743714662,
    'editedby' => 1,
    'editedon' => 1743797337,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1743790140,
    'publishedby' => 1,
    'menutitle' => '',
    'content_dispo' => 0,
    'hidemenu' => 0,
    ...
    'context_key' => 'web',
    'content_type' => 1,
    'uri' => 'index/articles/февральское-поступление.html',
    'uri_override' => 0,
    ...
    array (
      0 => 'article_image',
      1 => 'assets/templates/img/4a5ef21a40522a7cc5215fb34e282650.png',
      2 => 'default',
      3 => NULL,
      4 => 'image',
    ),
...
<html lang="ru">
    <head>
        ...
        <title>Февральское поступление - MODX Revolution</title>
        ...
        <section class="py-12 lg:py-16 px-6 lg:px-[120px]">
            <div class="flex flex-col items-center">
                <div class="max-w-5xl w-full">
                    <img
                        src="http://localhost/assets/templates/img/4a5ef21a40522a7cc5215fb34e282650.png"
                        alt="Февральское поступление"
                    ...
                    <div class="w-full mt-6">
                        <div class="max-w-[700px]">
                            ...
                            <div class="text-xs lg:text-sm mt-2">
  ...
  array (
    ...
    '[[*article_image]]' => 'assets/templates/img/4a5ef21a40522a7cc5215fb34e282650.png',
    '[[*longtitle]]' => 'Февральское поступление товара и актуальные скидки',
    '[[*description]]' => 'Экономьте на ремонте своего автомобиля, не упуская выгодных возможностей',
